...
describe("sdk discovery schemas", () => {
  ...
  it("validates package viability state combinations", () => {
    ...
    expect(Schema.decodeUnknownSync(HulyPackageViabilitySchema)(usableInventory).mcpStatus).toBe("usable_for_discovery")
    expect(
    ...
    expect(() =>
      Schema.decodeUnknownSync(HulyPackageViabilitySchema)({ ...usableInventory, publishStatus: "not_published" })
    ).toThrow()
    expect(() =>
      Schema.decodeUnknownSync(HulyPackageViabilitySchema)({
        ...usableInventory,
    ...
    expect(() =>
      Schema.decodeUnknownSync(HulyPackageViabilitySchema)({ ...blockedBoard, blockedReason: undefined })
    ).toThrow()
    expect(() =>
      Schema.decodeUnknownSync(HulyPackageViabilitySchema)({
        ...blockedBoard,
