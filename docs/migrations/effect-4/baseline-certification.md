...
| `pnpm check-all` | pass | Complete aggregate passed after final review edits: 283 files and all 4,243 tests; 99.61% statements, 99.01% branches, 99.35% functions, and 99.66% lines; 244/300 successful output lines. |
