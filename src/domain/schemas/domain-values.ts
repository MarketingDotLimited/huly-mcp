...
export const LocalFilePath = Schema.String.pipe(
  Schema.brand("LocalFilePath"),
  Schema.annotate({
...
export const Base64FileData = Schema.String.pipe(
  Schema.brand("Base64FileData"),
  Schema.annotate({
...
export const AttachmentFileName = NonEmptyString.pipe(
  Schema.brand("AttachmentFileName"),
  Schema.annotate({
...
export const AttachmentDescription = Schema.String.pipe(
  Schema.brand("AttachmentDescription"),
  Schema.annotate({
...
export const AttachmentByteSize = NonNegativeInteger.pipe(
  Schema.brand("AttachmentByteSize"),
  Schema.annotate({
...
export const AttachmentMetadataKey = Schema.String.pipe(
  Schema.brand("AttachmentMetadataKey"),
  Schema.annotate({
...
export const DisplayText = NonEmptyString.pipe(
  Schema.brand("DisplayText"),
  Schema.annotate({
...
export const ActivityMarkup = Schema.String.pipe(
  Schema.brand("ActivityMarkup"),
  Schema.annotate({
...
export const ActivityMarkdown = Schema.String.pipe(
  Schema.brand("ActivityMarkdown"),
  Schema.annotate({
...
export const MentionContent = Schema.String.pipe(
  Schema.brand("MentionContent"),
  Schema.annotate({
...
export const DrawingContent = Schema.String.pipe(
  Schema.brand("DrawingContent"),
  Schema.annotate({
...
export const ActivityFilterPosition = Integer.pipe(
  Schema.brand("ActivityFilterPosition"),
  Schema.annotate({
...
export const NotificationProviderOrder = Integer.pipe(
  Schema.brand("NotificationProviderOrder"),
  Schema.annotate({
...
export const NotificationFieldName = NonEmptyString.pipe(
  Schema.brand("NotificationFieldName"),
  Schema.annotate({
