...
export const SetRelatedIssueTargetParamsSchema = Schema.Struct({
  ...
  .pipe(Schema.filter(validateRelatedIssueTargetLocator))
  .annotations({
...
export const parseDeleteRelatedIssueSpaceTargetParams = Schema.decodeUnknown(DeleteRelatedIssueSpaceTargetParamsSchema)
