...
export const ListNotificationsParamsSchema = Schema.Struct({
  limit: Schema.optional(
    LimitParam.annotations({ description: `Maximum number of notifications to return (default: ${DEFAULT_LIMIT})` })
  ),
  ...
  unreadOnly: Schema.optional(
    Schema.Boolean.annotations({ description: `Return only unread notifications (default: ${DEFAULT_UNREAD_ONLY})` })
  )
}).annotations({ title: "ListNotificationsParams", description: "Parameters for listing notifications" })
...
export const GetNotificationParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID" })
}).annotations({ title: "GetNotificationParams", description: "Parameters for getting a single notification" })
...
export const MarkNotificationReadParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID to mark as read" })
}).annotations({ title: "MarkNotificationReadParams", description: "Parameters for marking a notification as read" })
...
export const MarkNotificationUnreadParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID to mark as unread" })
}).annotations({
...
export const ArchiveNotificationParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID to archive" })
}).annotations({ title: "ArchiveNotificationParams", description: "Parameters for archiving a notification" })
...
export const UnarchiveNotificationParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID to unarchive" })
}).annotations({ title: "UnarchiveNotificationParams", description: "Parameters for unarchiving a notification" })
...
export const DeleteNotificationParamsSchema = Schema.Struct({
  notificationId: NotificationId.annotations({ description: "Notification ID to delete" })
}).annotations({ title: "DeleteNotificationParams", description: "Parameters for deleting a notification" })
...
export const GetNotificationContextParamsSchema = Schema.Struct({
  objectId: DocId.annotations({ description: "Object ID to get notification context for" }),
  objectClass: ObjectClassName.annotations({ description: "Object class name (e.g., 'tracker.class.Issue')" })
}).annotations({
...
export const ListNotificationContextsParamsSchema = Schema.Struct({
  limit: Schema.optional(
    LimitParam.annotations({ description: `Maximum number of contexts to return (default: ${DEFAULT_LIMIT})` })
  ),
...
}).annotations({ title: "ListNotificationContextsParams", description: "Parameters for listing notification contexts" })
...
export const PinNotificationContextParamsSchema = Schema.Struct({
  contextId: NotificationContextId.annotations({ description: "Notification context ID to pin/unpin" }),
  pinned: Schema.Boolean.annotations({ description: "Whether to pin (true) or unpin (false) the context" })
}).annotations({
...
export const HideNotificationContextParamsSchema = Schema.Struct({
  contextId: NotificationContextId.annotations({ description: "Notification context ID to hide/unhide" }),
  hidden: Schema.Boolean.annotations({ description: "Whether to hide (true) or unhide (false) the context" })
}).annotations({
...
export const ListNotificationSettingsParamsSchema = Schema.Struct({
  limit: Schema.optional(
    LimitParam.annotations({ description: `Maximum number of settings to return (default: ${DEFAULT_LIMIT})` })
  )
}).annotations({ title: "ListNotificationSettingsParams", description: "Parameters for listing notification settings" })
...
export const UpdateNotificationProviderSettingParamsSchema = Schema.Struct({
  providerId: NotificationProviderId.annotations({ description: "Notification provider ID" }),
  enabled: Schema.Boolean.annotations({ description: "Whether to enable or disable the provider" })
}).annotations({
