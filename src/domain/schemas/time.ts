...
export const LogTimeResultSchema = Schema.Struct({ reportId: TimeSpendReportId, identifier: IssueIdentifier })
export type LogTimeResult = Schema.Schema.Type<typeof LogTimeResultSchema>

export const StartTimerResultSchema = Schema.Struct({ identifier: IssueIdentifier, startedAt: Timestamp })
