...
}).annotations({ title: "TagCategorySummary", description: "Tag category summary for list operations" })
...
}).annotations({ title: "ListTagCategoriesParams", description: "Parameters for listing tag categories" })
...
export const CreateTagCategoryParamsSchema = Schema.Struct({
  label: NonEmptyString.annotations({ description: "Category name" }),
  targetClass: Schema.optional(
    NonEmptyString.annotations({
...
}).annotations({ title: "CreateTagCategoryParams", description: "Parameters for creating a tag category" })
...
export const UpdateTagCategoryParamsSchema = Schema.Struct({
  category: TagCategoryIdentifier.annotations({ description: "Category ID or label name to update" }),
  label: Schema.optional(NonEmptyString.annotations({ description: "New category name" })),
  default: Schema.optional(Schema.Boolean.annotations({ description: "New default flag" }))
})
  .pipe(
...
export const DeleteTagCategoryParamsSchema = Schema.Struct({
  category: TagCategoryIdentifier.annotations({ description: "Category ID or label name to delete" })
}).annotations({ title: "DeleteTagCategoryParams", description: "Parameters for deleting a tag category" })
