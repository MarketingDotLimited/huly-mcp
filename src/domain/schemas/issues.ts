...
export const IssuePrioritySchema = Schema.transformOrFail(Schema.String, IssuePriorityLiteral, {
  strict: true,
...
export const LabelSchema = Schema.Struct({
  title: NonEmptyString.annotations({ description: "Human-readable label title." }),
...
export const IssueSchema = Schema.Struct({
  ...
  estimation: Schema.optional(PositiveTimeHours.annotations({ description: timeHoursDescription("Issue estimation") }))
}).annotations({ title: "Issue", description: "Full issue with all fields" })
...
const ListIssuesParamsBase = Schema.Struct({
  ...
  status: Schema.optional(
    StatusName.annotations({ description: "Filter by exact workflow status name. Does not accept category aliases." })
  ),
  statusCategory: Schema.optional(
    KnownStatusCategoryValueSchema.annotations({
  ...
  descriptionSearch: Schema.optional(
    Schema.String.annotations({ description: "Search issues by description content (fulltext search)" })
  ),
  component: Schema.optional(ComponentIdentifier.annotations({ description: "Filter by component ID or label" })),
  ...
  limit: Schema.optional(
    LimitParam.annotations({ description: `Maximum number of issues to return (default: ${DEFAULT_LIMIT})` })
  )
})
...
}).annotations({ title: "GetIssueParams", description: "Parameters for getting a single issue" })
...
export const CreateIssueParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  title: NonEmptyString.annotations({ description: "Issue title" }),
  ...
  priority: Schema.optional(
    IssuePrioritySchema.annotations({ description: "Issue priority (urgent, high, medium, low, no-priority)" })
  ),
  assignee: Schema.optional(PersonRefInput.annotations({ description: "Assignee email address or display name" })),
  status: Schema.optional(
  ...
  estimation: Schema.optional(PositiveTimeHours.annotations({ description: timeHoursDescription("Time estimation") }))
}).annotations({ title: "CreateIssueParams", description: "Parameters for creating an issue" })
...
export const UpdateIssueParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  identifier: IssueIdentifier.annotations({ description: "Issue identifier (e.g., 'HULY-123')" }),
  title: Schema.optional(NonEmptyString.annotations({ description: "New issue title" })),
  description: Schema.optional(
    clearableText(
  ...
  priority: Schema.optional(IssuePrioritySchema.annotations({ description: "New issue priority" })),
  assignee: Schema.optional(
    Schema.NullOr(PersonRefInput).annotations({ description: "New assignee email or display name (null to unassign)" })
  ),
  status: Schema.optional(StatusName.annotations({ description: "New status" })),
  taskType: Schema.optional(
    TaskTypeRefSchema.annotations({
      description:
...
export const AddLabelParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  identifier: IssueIdentifier.annotations({ description: "Issue identifier (e.g., 'HULY-123')" }),
  label: NonEmptyString.annotations({ description: "Label name to add" }),
  color: Schema.optional(
    ColorCode.annotations({
      description: `Huly platform color palette index from 0 through ${MAX_COLOR_INDEX} (default: ${DEFAULT_COLOR_INDEX})`
    })
  )
}).annotations({ title: "AddLabelParams", description: "Parameters for adding a label to an issue" })
...
export const DeleteIssueParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  identifier: IssueIdentifier.annotations({ description: "Issue identifier (e.g., 'HULY-123')" })
}).annotations({ title: "DeleteIssueParams", description: "Parameters for deleting an issue" })
...
export const RemoveLabelParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  identifier: IssueIdentifier.annotations({ description: "Issue identifier (e.g., 'HULY-123')" }),
  label: NonEmptyString.annotations({ description: "Label name to remove" })
}).annotations({ title: "RemoveLabelParams", description: "Parameters for removing a label from an issue" })
...
export const MoveIssueParamsSchema = Schema.Struct({
  project: ProjectIdentifier.annotations({ description: "Project identifier (e.g., 'HULY')" }),
  identifier: IssueIdentifier.annotations({ description: "Issue to move (e.g., 'HULY-123')" }),
