...
export class ApprovalRequestTargetNotFoundError extends Schema.TaggedError<ApprovalRequestTargetNotFoundError>()(
  ...
  { attachedTo: Schema.String, attachedToClass: Schema.String }
) {
  override get message(): string {
...
export class ApprovalRequestInvalidApprovalThresholdError extends Schema.TaggedError<ApprovalRequestInvalidApprovalThresholdError>()(
  "ApprovalRequestInvalidApprovalThresholdError",
  { requiredApprovesCount: Count, requestedCount: Count }
) {
  override get message(): string {
...
export class ApprovalRequestMutationUnsupportedError extends Schema.TaggedError<ApprovalRequestMutationUnsupportedError>()(
  "ApprovalRequestMutationUnsupportedError",
  { operation: Schema.String, capability: Schema.String }
) {
  override get message(): string {
...
export class ApprovalRequestNotActiveError extends Schema.TaggedError<ApprovalRequestNotActiveError>()(
  ...
  { request: Schema.String, status: Schema.String }
) {
  override get message(): string {
...
export class ApprovalRequestApproverNotRequestedError extends Schema.TaggedError<ApprovalRequestApproverNotRequestedError>()(
  "ApprovalRequestApproverNotRequestedError",
  { request: Schema.String, person: Schema.String }
) {
  override get message(): string {
...
export class ApprovalRequestCancelUnauthorizedError extends Schema.TaggedError<ApprovalRequestCancelUnauthorizedError>()(
  "ApprovalRequestCancelUnauthorizedError",
  { request: Schema.String, actor: Schema.String, creator: Schema.optional(Schema.String) }
) {
  override get message(): string {
