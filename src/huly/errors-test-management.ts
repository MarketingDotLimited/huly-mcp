...
export class TestSuiteNotFoundError extends Schema.TaggedError<TestSuiteNotFoundError>()("TestSuiteNotFoundError", {
  identifier: Schema.String
}) {
  override get message(): string {
...
export class TestCaseNotFoundError extends Schema.TaggedError<TestCaseNotFoundError>()("TestCaseNotFoundError", {
  identifier: Schema.String
}) {
  override get message(): string {
...
export class TestPlanNotFoundError extends Schema.TaggedError<TestPlanNotFoundError>()("TestPlanNotFoundError", {
  identifier: Schema.String
}) {
  override get message(): string {
...
export class TestRunNotFoundError extends Schema.TaggedError<TestRunNotFoundError>()("TestRunNotFoundError", {
  identifier: Schema.String
}) {
  override get message(): string {
...
export class TestResultNotFoundError extends Schema.TaggedError<TestResultNotFoundError>()("TestResultNotFoundError", {
  identifier: Schema.String
}) {
  override get message(): string {
...
export class TestPlanItemNotFoundError extends Schema.TaggedError<TestPlanItemNotFoundError>()(
  ...
  { identifier: Schema.String, plan: Schema.String }
) {
  override get message(): string {
