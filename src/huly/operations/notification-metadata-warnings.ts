...
export type NotificationMetadataWarningDefinition =
  ...
  | {
    ...
    readonly presentationFields: "label"
  }
...
export const warnNotificationMetadataFallback = (
  ...
  Effect.gen(function*() {
    ...
    const invalidDetail = config.invalidRows === 0
      ? ""
    ...
    yield* diagnostics.warnAgent({
      ...
      message: `Authoritative Huly model-space ${config.subject} metadata was ${config.modelFailure}; `
