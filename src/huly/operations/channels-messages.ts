...
type UpdateChannelMessageError = HulyClientError | ChannelNotFoundError | MessageNotFoundError

type DeleteChannelMessageError = HulyClientError | ChannelNotFoundError | MessageNotFoundError
...
export const updateChannelMessage = (
  ...
  Effect.gen(function* () {
    ...
    yield* client.updateDoc(chunter.class.ChatMessage, channel._id, message._id, updateOps)
...
export const deleteChannelMessage = (
  ...
  Effect.gen(function* () {
    ...
    yield* client.removeDoc(chunter.class.ChatMessage, channel._id, message._id)
