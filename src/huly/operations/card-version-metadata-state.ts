...
type MetadataWithout<K extends "isLatest" | "readonly"> = Omit<CardVersionMetadata, K> & { readonly [P in K]?: never }

type RecoveredMetadataDegradation =
  | {
      readonly resolution: { readonly _tag: "RecoveredMetadata"; readonly metadata: MetadataWithout<"isLatest"> }
      readonly degradedFields: readonly ["isLatest"]
    }
  | {
      readonly resolution: { readonly _tag: "RecoveredMetadata"; readonly metadata: MetadataWithout<"readonly"> }
...
export type CoherentCardVersionMetadata = { readonly _tag: "Coherent"; readonly metadata: CardVersionMetadata }

export type RecoveredCardVersionMetadata = { readonly _tag: "Degraded" } & RecoveredMetadataDegradation
...
export type ParsedCardVersionMetadata =
  ...
  | {
      ...
      readonly resolution: { readonly _tag: "RecoveredChain"; readonly chainId: CardVersionChainId }
