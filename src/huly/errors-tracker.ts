 ...
 */
export class IssueNotFoundError extends Schema.TaggedError<IssueNotFoundError>()("IssueNotFoundError", {
 ...
 */
export class InvalidStatusError extends Schema.TaggedError<InvalidStatusError>()("InvalidStatusError", {
 ...
 */
export class IssueReferenceError extends Schema.TaggedError<IssueReferenceError>()("IssueReferenceError", {
 ...
 */
export class CommentNotFoundError extends Schema.TaggedError<CommentNotFoundError>()("CommentNotFoundError", {
 ...
 */
export class MilestoneNotFoundError extends Schema.TaggedError<MilestoneNotFoundError>()("MilestoneNotFoundError", {
  identifier: Schema.String,
  project: Schema.String
}) {
  override get message(): string {
...
export class TemplateChildNotFoundError extends Schema.TaggedError<TemplateChildNotFoundError>()(
  ...
  { childId: Schema.String, template: Schema.String, project: Schema.String }
) {
  override get message(): string {
