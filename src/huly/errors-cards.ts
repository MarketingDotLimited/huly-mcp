...
export class CardSpaceNotFoundError extends Schema.TaggedError<CardSpaceNotFoundError>()("CardSpaceNotFoundError", {
...
export class CardNotFoundError extends Schema.TaggedError<CardNotFoundError>()("CardNotFoundError", {
...
export class MasterTagNotFoundError extends Schema.TaggedError<MasterTagNotFoundError>()("MasterTagNotFoundError", {
...
export class CardCommentNotFoundError extends Schema.TaggedError<CardCommentNotFoundError>()(
  ...
  { commentId: CommentId, card: CardIdentifier, cardSpace: CardSpaceIdentifier }
) {
  override get message(): string {
