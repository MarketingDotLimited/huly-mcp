...
Release evidence: `pnpm check-all` passed; the packed CLI live behavior/risk suite passed against local Huly; the full MCP suite passed 1,095 tests with 0 failures and 27 intentional skips; fresh tarballs installed and passed smoke tests with both pnpm and npm; and the packed 522-route CLI passed on Node 20, 22, 24, and 26.
